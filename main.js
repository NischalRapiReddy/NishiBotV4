...
const starts = async (DogeXeonOP = new WAConnection()) => {
    ...
    console.log(color(figlet.textSync('Nishi Bot', {
		font: 'Standard',
	...
	console.log(color('\n> YT CHANNEL: Nischal ','silver'))
console.log(color('> GITHUB: NischalRapireddy ','silver'))
console.log(color('> WA NUMBER: +918919822103 ','silver'))
console.log(color('  NishiBot inc. 2022','mediumseagreen'))
    ...
    console.log(color('<>','red'), color('But? Error? Suggestion? Visit Here:', 'aqua'), color('https://wa.me/918919822103'))
    ...
    DogeXeonOP.sendMessage(`918919822103@s.whatsapp.net`, `Thanks bro, your bot is working on my whatsapp number ez😂`, MessageType.extendedText)
...
DogeXeonOP.on("group-participants-update", async (anu) => {
    ...
    //     DogeXeonOP.sendMessage(anu.jid, "Hello everyone, am Nishi Bot, ready to help you here ㋛︎", "conversation")
    //   }
      ...
      welcomeButt = { contentText: `${teks}`, footerText: `𝗡𝗶𝘀𝗵𝗶 𝗕𝗼𝘁 𝗩𝟰`, buttons: welcomeBut, headerType: 6, locationMessage: bosco2.message.locationMessage}
      ...
      goodbyeButt = { contentText: `${out}`, footerText: `𝗡𝗶𝘀𝗵𝗶 𝗕𝗼𝘁 𝗩𝟰`, buttons: goodbyeBut, headerType: 6, locationMessage: bosco3.message.locationMessage}
